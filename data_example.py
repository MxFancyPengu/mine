...
# the code even if the dictionaries in parser are not working_on. This also helps the student responsible
...
fake_corpus_data = {
    ...
    'document2': ['freeware', 'somebody', 'in', 'was', 'also', 'having', 'trouble', 'using', 'a', 'in', 'his',
...
# Unique words are those that appear only once in the document
fake_doc_dictionary = {
    'document1': ['when', 'the', 'powerbook', 'falls', 'asleep', 'said', 'was', 'sure', 'such', 'a', 'thing', 'existed',
                  'and'],
    'document2': ['freeware', 'somebody', 'was', 'also', 'having', 'trouble', 'using', 'a', 'his', 'of',
...
# In a comment is the calculation. You don't have to implement the log in base 10 function rather, use
# the one in the math package  math.log10()
fake_adjusted_index = {
    'the': 0.1760,      # log(3/2)
    'that': 0.1760,     # log(3/2)
    'he': 0.4771,       # log(3/1)
